...
vec4 mapFlower(vec3 p, bool col_required) {
    ...
    vec4 p0 = mapPetal(roty(-0.4)*(q-vec3(0.8,0,-0.2)), 0.45, -0.1, col_required);
    q = vec3(r*cossin(asin(0.999*sin(3.5*a-0.2*sin(4.0*r)*cos(5.0*a)+0.0))/3.5), p.z);
    vec4 p1 = mapPetal(roty(-0.1)*(q-vec3(1.0,0,-0.05)), 0.5, -0.2, col_required);
    q = vec3(r*cossin(asin(0.999*sin(3.0*a-0.2*cos(4.0*r)*cos(3.0*a)-0.9))/3.0), p.z);
    vec4 p2 = mapPetal(rotx(0.1)*roty(0.1)*(q-vec3(1.0,0,0.1)), 0.55, -0.1, col_required);
    q = vec3(r*cossin(asin(0.999*sin(3.0*a-0.2*cos(4.0*r)*cos(4.0*a)-2.0))/3.0), p.z);
    vec4 p3 = mapPetal(roty(0.4)*(q-vec3(0.7,0,0.16)), 0.55, -0.05, col_required);
    q = vec3(r*cossin(asin(0.999*sin(2.5*a-0.2*sin(3.0*r)*sin(3.0*a)-2.7))/2.5), p.z);
    vec4 p4 = mapPetal(roty(0.6)*(q-vec3(0.6,0,0.2)), 0.45, 0.05, col_required);
    q = vec3(r*cossin(asin(0.999*sin(2.0*a-0.3*sin(3.0*r)*sin(3.0*a)-3.5))/2.0), p.z);
    vec4 p5 = mapPetal(roty(0.7)*(q-vec3(0.4,0,0.15)), 0.4, 0.2, col_required);
    ...
    vec4 f1 = mapFilament(roty(-0.7-0.1*cos(4.0*a))*(q-vec3(0.2,0,0.0)), 0.8, col_required);
    q = vec3(r*cossin(asin(0.999*sin(4.0*a+1.5))/4.0), p.z);
    vec4 f2 = mapFilament(roty(-0.8+0.1*sin(3.0*a))*(q-vec3(0.18,0,0.0)), 0.8, col_required);
